...
import com.fixeam.icoser.network.LoginResponse
import com.fixeam.icoser.network.SendVerifyCodeResponse
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 设置颜色主题
        setStatusBar(this, Color.parseColor("#F3F3F3"), Color.parseColor("#0C0C0C"))
