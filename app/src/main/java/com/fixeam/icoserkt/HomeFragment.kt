...
class HomeFragment : Fragment() {
    ...
    private fun initModelData(view: View){
        val modelView: LinearLayout = view.findViewById(R.id.model_view)
    ...
    private fun initAlbumFlashPanel(album: Albums, forbiddenCallback: () -> Unit){
        ...
        collection?.setOnClickListener {
            ...
            setAlbumCollection(requireContext(), album, "default", { collectioncallback() }, { unlog() })
        }
